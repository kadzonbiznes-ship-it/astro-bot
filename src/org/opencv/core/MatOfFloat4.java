...
/* 39 */     if (elemNumber > 0)
/* 40 */       create(elemNumber, 1, CvType.makeType(5, 4)); 
/*    */   }
/*    */   
/*    */   public void fromArray(float... a) {
/* 44 */     if (a == null || a.length == 0)
/*    */       return; 
/* 46 */     int num = a.length / 4;
/* 47 */     alloc(num);
/* 48 */     put(0, 0, a);
/*    */   }
/*    */   
/*    */   public float[] toArray() {
/* 52 */     int num = checkVector(4, 5);
/* 53 */     if (num < 0)
/* 54 */       throw new RuntimeException("Native Mat has unexpected type or size: " + toString()); 
/* 55 */     float[] a = new float[num * 4];
/* 56 */     if (num == 0)
/* 57 */       return a; 
/* 58 */     get(0, 0, a);
/* 59 */     return a;
...
/* Location:              C:\Users\waria\Desktop\Nowy folder\Bot4life-1.jar!\org\opencv\core\MatOfFloat4.class
