...
/*     */   public static final int CAP_OPENNI_DEPTH_GENERATOR = -2147483648;
...
/* 444 */     return getBackendName_0(api);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 500 */     return isBackendBuiltIn_0(api);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 516 */     double[] version_ABI_out = new double[1];
/* 517 */     double[] version_API_out = new double[1];
/* 518 */     String retVal = getCameraBackendPluginVersion_0(api, version_ABI_out, version_API_out);
/* 519 */     if (version_ABI != null) version_ABI[0] = (int)version_ABI_out[0]; 
/* 520 */     if (version_API != null) version_API[0] = (int)version_API_out[0]; 
/* 521 */     return retVal;
/*     */   }
/*     */ 
/*     */ 
...
/* 537 */     double[] version_ABI_out = new double[1];
/* 538 */     double[] version_API_out = new double[1];
/* 539 */     String retVal = getStreamBackendPluginVersion_0(api, version_ABI_out, version_API_out);
/* 540 */     if (version_ABI != null) version_ABI[0] = (int)version_ABI_out[0]; 
/* 541 */     if (version_API != null) version_API[0] = (int)version_API_out[0]; 
/* 542 */     return retVal;
/*     */   }
/*     */ 
/*     */ 
...
/* 558 */     double[] version_ABI_out = new double[1];
/* 559 */     double[] version_API_out = new double[1];
/* 560 */     String retVal = getWriterBackendPluginVersion_0(api, version_ABI_out, version_API_out);
/* 561 */     if (version_ABI != null) version_ABI[0] = (int)version_ABI_out[0]; 
/* 562 */     if (version_API != null) version_API[0] = (int)version_API_out[0]; 
/* 563 */     return retVal;
/*     */   }
/*     */   
/*     */   private static native String getBackendName_0(int paramInt);
/*     */   
/*     */   private static native boolean hasBackend_0(int paramInt);
/*     */   
/*     */   private static native boolean isBackendBuiltIn_0(int paramInt);
/*     */   
/*     */   private static native String getCameraBackendPluginVersion_0(int paramInt, double[] paramArrayOfdouble1, double[] paramArrayOfdouble2);
/*     */   
/*     */   private static native String getStreamBackendPluginVersion_0(int paramInt, double[] paramArrayOfdouble1, double[] paramArrayOfdouble2);
/*     */   
/*     */   private static native String getWriterBackendPluginVersion_0(int paramInt, double[] paramArrayOfdouble1, double[] paramArrayOfdouble2);
/*     */ }


/* Location:              C:\Users\waria\Desktop\Nowy folder\Bot4life-1.jar!\org\opencv\videoio\Videoio.class
