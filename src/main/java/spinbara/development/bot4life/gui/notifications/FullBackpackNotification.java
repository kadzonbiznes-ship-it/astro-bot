...
/**
 * Niewielkie powiadomienie o pełnym plecaku.
 */
public class FullBackpackNotification extends JFrame {
    ...
    public FullBackpackNotification() {
        ...
        setContentPane(new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint bgGradient = new GradientPaint(0, 0, new Color(255, 140, 0, (int) (alpha * 240)),
                        0, getHeight(), new Color(255, 69, 0, (int) (alpha * 240)));
                ...
                String text = "Pełny plecak, podejmij działania";
